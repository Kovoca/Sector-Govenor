function scr_scrollbar(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
    ...
    if ((argument5 != 0) && (argument5 > argument4)) {
        ...
        if ((!instance_exists(obj_controller)) && instance_exists(obj_creation)) {
            var checka = 0;
            if ((!mouse_button_held(mb_left)) && (obj_creation.scrollbar_engaged == 1)) {
                obj_creation.scrollbar_engaged = 0;
            }
            if (mouse_button_held(mb_left) && (mouse_x >= xx + argument0) && (mouse_y >= yy + argument1) && (mouse_x < xx + argument2) && (mouse_y < yy + argument3)) {
                obj_creation.scrollbar_engaged = 1;
            }

            checka = 1;

            if ((obj_creation.scrollbar_engaged == 1) && (checka > 0)) {
                ...
                if (center > argument3 - siz2) {
                    center = argument3 - siz2;
                }
        ...
        if (instance_exists(obj_controller)) {
            var checka = 0;
            if ((!mouse_button_held(mb_left)) && (obj_controller.scrollbar_engaged == 1)) {
                obj_controller.scrollbar_engaged = 0;
            }
            if (mouse_button_held(mb_left) && (mouse_x >= xx + argument0) && (mouse_y >= yy + argument1) && (mouse_x < xx + argument2) && (mouse_y < yy + argument3)) {
                obj_controller.scrollbar_engaged = 1;
            }

            if ((obj_controller.managing > 0 || obj_controller.managing == -1) && (obj_controller.menu != 30) && (obj_controller.man_max - MANAGE_MAN_SEE > -1)) {
                checka = 1;
            }
            if (instance_exists(obj_popup)) {
                if ((obj_popup.type == 8) && (obj_popup.target_comp >= 0)) {
                    if (obj_controller.man_max - MANAGE_MAN_SEE > -1) {
                        checka = 1;
                    }
                }
            }

            if ((obj_controller.scrollbar_engaged == 1) && (checka > 0)) {
                var click_y, center, ratio, ss, tmv, cp;
                ratio = 0;
                ss = 0;
                tmv = 0;
                ...
                if (checka == 1) {
                    ...
                    if (obj_controller.man_current > (obj_controller.man_max - MANAGE_MAN_SEE)) {
                        obj_controller.man_current = obj_controller.man_max - MANAGE_MAN_SEE;
                    }

                    if (obj_controller.man_current < 0) {
                        obj_controller.man_current = 0;
                    }
                }
