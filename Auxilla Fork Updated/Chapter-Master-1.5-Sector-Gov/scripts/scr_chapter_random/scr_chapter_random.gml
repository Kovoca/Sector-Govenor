...
function scr_chapter_random(custom_or_random) {
    // custom_or_random = 0 = create custom
    // custom_or_random = 1 = create random
    ...
    lens_color = 1;
    weapon_color = 1;
    col_special = choose(0, 0, 0, 0, 0, 1, 2, 3);
    ...
    // create random
    if (custom_or_random == 1) {
        strength = choose(2, 3, 4, 5, 6, 7, 8);
        purity = choose(2, 3, 4, 5, 6, 7, 8);
        if (strength < 5) {
            purity += 2;
        }
        stability = choose(20, 30, 40, 50, 60, 70, 80);
        if (purity < 5) {
            stability += 19;
        }
        cooperation = choose(2, 3, 4, 5, 6, 7, 8);
        if (stability < 90) {
            cooperation += 2;
        }
    ...
    if (custom_or_random == 1) {
        ...
        if (found_secret == 4) {
            adv[1] = "Bolter Drilling";
            betchers = 1;
            membrane = 1;
            mutations_selected += 2;
            mutations += 2;
            mutat = 2;
        }
        if (found_secret == 5) {
	...
	*/
    ...
    if (custom_or_random == 1) {
        ...
        if (fleet_type != 2) {
            ...
            if (rando == 1) {
                monastery_name = string(phrase2) + "' Ship";
            }
            if (rando == 2) {
                monastery_name = "Crown " + string_delete(phrase2, string_length(phrase2), 1);
            }
            if (rando == 3) {
                monastery_name = "Head " + string_delete(phrase2, string_length(phrase2), 1);
            }
            if (rando == 4) {
                monastery_name = string(phrase2) + "' Fist";
            }
            if (rando == 5) {
                monastery_name = string(phrase2) + "' Gaze";
            }
        }
    }
    ...
    if (custom_or_random == 0) {
        fleet_type = choose(1, 2);
    }
}
